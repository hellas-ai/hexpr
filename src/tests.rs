...
fn test_nested_expressions() {
    ...
    assert_eq!(
        result,
        Hexpr::Composition(vec![
            Hexpr::Tensor(vec![Hexpr::Operation("add".to_string())]),
            Hexpr::Composition(vec![
                Hexpr::Operation("sub".to_string()),
                Hexpr::Operation("mul".to_string()),
            ]),
...
fn test_names_with_dashes_and_underscores() {
    ...
    assert_eq!(result, Hexpr::Operation("my-operation_2".to_string()));
}
